...
exact solution: f = cos(z) + z^2 + C sin(z), here I take C=0
***************************************************************/
#include<iostream>
#include <stdio.h>
...
way.
  ***************************************/
  ...
  cout<<a_data[0]<<"   "<<a_data[1]<<"   "<<a_data[2]<<"   "<<a_data[3]<<endl;
  cout<<a_data[4]<<"   "<<a_data[5]<<"   "<<a_data[6]<<"   "<<a_data[7]<<endl;
  cout<<a_data[8]<<"   "<<a_data[9]<<"   "<<a_data[10]<<"   "<<a_data[11]<<endl;
  cout<<a_data[12]<<"   "<<a_data[13]<<"   "<<a_data[14]<<"   "<<a_data[15]<<endl;
 ...
 ***************************************************/
  printf ("x = \n");//just a title line
  gsl_vector_fprintf (stdout, x, "      %1.6g");
/**************************************************
